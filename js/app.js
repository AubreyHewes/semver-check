...
},{"./components/semver-checker.jsx":151,"./libs/semver-constraint.js":164,"react":148,"semver":149}],2:[function(require,module,exports){
...
},{"../libs/semver-constraint.js":164,"react":148}],151:[function(require,module,exports){
var React = require('react'),
    semver = require('semver'),
    ...
    render: function() {
        return (
            React.createElement("div", null, 
                ...
                React.createElement(SemverExplain, {version:  this.state.version, constraint:  this.state.constraint})
            )
        );
    }
});
...
},{"./semver-checker-form.jsx":150,"./semver-explain.jsx":159,"./semver-feedback.jsx":160,"react":148,"semver":149}],152:[function(require,module,exports){
var React = require('react'),
    SemverConstraint = require('../libs/semver-constraint.js');

var SemverExplainConstraintBundler = React.createClass({displayName: "SemverExplainConstraintBundler",
        render: function() {
            ...
            return (
                React.createElement("p", null, 
                    "This ", React.createElement("a", {href: "http://guides.rubygems.org/patterns/#pessimistic-version-constraint"}, "pessimistic version constraint"), " is an operator provided by Bundler and RubyGems."
                )
            );
        }
    });
...
},{"../libs/semver-constraint.js":164,"react":148}],153:[function(require,module,exports){
var React = require('react'),
...
},{"../libs/semver-composer-constraint.js":163,"./semver-range.jsx":162,"react":148}],154:[function(require,module,exports){
var React = require('react'),
...
},{"../libs/semver-constraint.js":164,"./semver-if.jsx":161,"react":148}],155:[function(require,module,exports){
var React = require('react'),
    SemverRange = require('./semver-range.jsx'),
    SemverConstraint = require('../libs/semver-constraint.js');
...
},{"../libs/semver-constraint.js":164,"./semver-range.jsx":162,"react":148}],156:[function(require,module,exports){
var React = require('react'),
    SemverConstraint = require('../libs/semver-constraint.js'),
    If = require('./semver-if.jsx'),
    SemverRange = require('./semver-range.jsx');
...
var SemverExplainConstraintWarning = React.createClass({displayName: "SemverExplainConstraintWarning",
        render: function() {
            ...
            return (
                React.createElement("div", null, 
                    React.createElement(If, {test:  !this.props.constraint.upper() && ['version', 'range (advanced)'].indexOf(this.props.constraint.type()) === -1 && (['<', '<='].indexOf(this.props.constraint.operator()) === -1 && this.props.constraint.toString().indexOf('<') === -1) }, 
...
},{"../libs/semver-constraint.js":164,"./semver-if.jsx":161,"./semver-range.jsx":162,"react":148}],157:[function(require,module,exports){
var React = require('react'),
    SemverConstraint = require('../libs/semver-constraint.js');
...
},{"../libs/semver-constraint.js":164,"react":148}],158:[function(require,module,exports){
var React = require('react'),
    semver = require('semver');
...
},{"react":148,"semver":149}],159:[function(require,module,exports){
var React = require('react'),
    semver = require('semver'),
    ...
    render: function() {
        ...
        return (
            React.createElement("div", {className: "well"}, 
                ...
                React.createElement(SemverExplainConstraintBundler, {constraint:  this.props.constraint}), 
...
},{"./semver-explain-constraint-bundler.jsx":152,"./semver-explain-constraint-composer.jsx":153,"./semver-explain-constraint-includes.jsx":154,"./semver-explain-constraint-range.jsx":155,"./semver-explain-constraint-warning.jsx":156,"./semver-explain-constraint.jsx":157,"./semver-explain-version.jsx":158,"react":148,"semver":149}],160:[function(require,module,exports){
var React = require('react');
...
},{"./semver-if.jsx":161,"react":148}],163:[function(require,module,exports){
...
},{"./semver-constraint.js":164,"semver":149}],164:[function(require,module,exports){
var semver = require('semver'),
    padVersion = function (version, padding) {
        version = version.toString().split('.');
